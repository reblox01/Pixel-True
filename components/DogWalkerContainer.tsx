...
const DogWalkerContainer = memo(() => {
  return (
    <View style={styles.walkDog}>
      ...
      <View style={[styles.component, styles.componentLayout]}>
        <View style={styles.shape}>
          ...
          <Image
            ...
            resizeMode="cover"
            source={require("../assets/square-half3.png")}
          />
        </View>
      </View>
      ...
      />
      <Text style={styles.walkDog1}>Walk Dog</Text>
    </View>
  );
});
...
export default DogWalkerContainer;
