...
const HomepageNewHabitReminder = () => {
  return (
    <View style={styles.homepageNewHabitReminder}>
      <View style={styles.content}>
        ...
        <View style={styles.text}>
          <Text style={styles.text1}>New Habit</Text>
        </View>
      </View>
      <Dialog />
    </View>
...
export default HomepageNewHabitReminder;
